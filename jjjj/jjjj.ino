int infraPin1 = 22;    // pin del infrarrojos utilizado como entrada digital en el lado derecho(#1).
int infraPin2 = 24;    // pin del infrarrojos utilizado como entrada digital en el lado izquierdo(#2).
